...
const OtherProject = ({ project, idx }: OtherProjectProps) => {
  ...
  return (
    ...
    >
      <Animation.Fade
        direction="bottom"
        className="flex flex-col items-start justify-between h-full p-5 transition duration-150 ease-linear transform rounded shadow-lg cursor-pointer group bg-dark-light hover:-translate-y-1"
      >
